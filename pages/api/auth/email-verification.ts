...
import { VerificationTokenConstants } from "@/src/email-verification/verification-token-constants";
import { SaveEmailVerificationToken } from "@/src/email-verification/use-case/SaveEmailVerificationToken";
import { EmailVerificationToken } from "@/src/email-verification/domain/EmailVerificationToken";
...
export default async function handler(
  ...
  try {
    ...
    const verificationUrl = `${process.env.BASE_URL!}/${
      reqBody.userName
    }?email=${reqBody.email}&verificationToken=${id}`;
